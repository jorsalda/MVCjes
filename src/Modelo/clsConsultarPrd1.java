...
public class clsConsultarPrd1 extends clsConexion {

    public boolean registrar(clsProducto1 pro) {
    ...
    public boolean modificar(clsProducto1 pro) {
        PreparedStatement ps = null;
        Connection con = Conexion();
...
public boolean eliminar(clsProducto1 pro) {
        PreparedStatement ps = null;
        Connection con = Conexion();
    ...
    public boolean buscar(clsProducto1 pro) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection con = Conexion();
